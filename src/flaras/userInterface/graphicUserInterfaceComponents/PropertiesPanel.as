...
package flaras.userInterface.graphicUserInterfaceComponents
{
	...
	{	
		...
		public function PropertiesPanel(pStage:Stage, pCtrGUI:CtrGUI) {
			...
			ptX.addEventListener(KeyboardEvent.KEY_DOWN, pCtrGUI.restrictLetters);
			append(new JLabel(" Y "));
			append(ptY = new JTextField("", 3));
			ptY.addActionListener(pCtrGUI.textUpdate);
			ptY.addEventListener(KeyboardEvent.KEY_DOWN, pCtrGUI.restrictLetters);
			append(new JLabel(" Z "));
			append(ptZ = new JTextField("", 3));
			ptZ.addActionListener(pCtrGUI.textUpdate);
			ptZ.addEventListener(KeyboardEvent.KEY_DOWN, pCtrGUI.restrictLetters);
			//object properties
